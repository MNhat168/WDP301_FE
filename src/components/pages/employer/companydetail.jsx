          ...
          <div className="overflow-y-auto max-h-[calc(95vh-200px)]">
            <form onSubmit={handleEditSubmit} className="p-6">
              ...
              <div className="mb-8">
                ...
                <div className="relative h-40 rounded-lg bg-gradient-to-r from-blue-100 to-indigo-100 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center">
                  {editFormData.coverImage ? (
                    <img
                      src={URL.createObjectURL(editFormData.coverImage)}
                      alt="Cover preview"
                      className="w-full h-full object-cover rounded-lg"
                    />
                  ) : companyData?.com?.coverImage ? (
                    <img
                      src={companyData.com.coverImage}
                      alt="Current cover"
                      className="w-full h-full object-cover rounded-lg"
                    />
                  ) : (
                  ...
                  <label className="absolute bottom-3 right-3 bg-white rounded-full p-2 shadow-md cursor-pointer hover:bg-gray-50">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Recommended: 1584x396px. Max file size: 10MB
                </p>
              </div>
