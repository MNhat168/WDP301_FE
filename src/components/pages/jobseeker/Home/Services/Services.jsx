...
const servicesData = [
  {
    ...
    description:
      "Has a Front-End developer I have vast experience in making user-friendly web interfaces that help improve user experience .",
    serviceAnimation: {
      hidden: {
        x: "-100vw",
        opacity: 0,
  ...
  return (
    <section className="container px-6 mx-auto py-20" ref={ref}>
      <h2 className="mb-4 text-4xl md:text-5xl text-center tracking-tight font-extrabold  text-dark dark:text-white sm:leading-none">
        ...
        <span className="text-indigo-600 dark:text-indigo-500">Our Services</span>
      </h2>
      <p className="text-xl text-center dark:text-gray-600 my-4">
        It's important to have unique and attractive designs so that your
        audience sticks around with your site. Check out some of the services I
        render.
      </p>
