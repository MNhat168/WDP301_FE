      ...
      <nav className="flex items-center justify-between h-20 px-6 sm:px-12 max-w-7xl mx-auto">
        ...
        <ul className="hidden sm:flex items-center space-x-2">
          ...
          <li>
            <Link
              to="/employer/blogs"
              className="group flex items-center space-x-2 px-4 py-2 rounded-xl bg-white/40 backdrop-blur-sm hover:bg-white/60 text-gray-700 hover:text-green-600 font-medium transition-all duration-300 hover:shadow-lg"
            >
              <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-green-500 to-green-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
